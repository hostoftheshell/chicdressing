...
<footer id="page-footer" class="<?php echo esc_attr(ashe_options( 'general_footer_width' )) === 'boxed' ? 'boxed-wrapper ': ''; ?>clear-fix">
    ...
    <div class="footer-copyright">
        ...
        <div class="credit">
            ...
            printf( __( '%1$s Theme by <a href="%2$s" aria-label="Theme WordPress Royal Themes">%3$s.</a>', 'ashe' ), esc_html( $theme_data->Name ), esc_url( 'https://wp-royal-themes.com/' ), $theme_data->Author );
            ?>
        </div>
